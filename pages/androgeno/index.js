...
function App() {
  const [message, setMessage] = useState(
    "Esse site é dedicado para Pamella, minha esposa, parceira e amor de minha vida. Sabe que desejo te dar todas as maravilhas do universo e compartilhar esse pequeno tempo que temos de vida e sonhos. Obrigado pelo apoio de tornar isso real.",
  );
  ...
  function handleClick() {
    if (currentImageId === 0) {
      ...
      setImage(image11);
      setCaption(
        "mas é um desafio, porque ficar de grudinho é a melhor coisa que existe",
      );
      setText();
